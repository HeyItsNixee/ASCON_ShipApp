...
c3d_constexpr bool is_exist( _Iterator begIt, _Iterator endIt, const _Element & elem )
{
...
c3d_constexpr bool is_exist_if( _Iterator begIt, _Iterator endIt, UnaryPredicate _Pred )
{
